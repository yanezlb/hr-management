        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('name')
                    ->label('State Name')
                    ->searchable() // ->searchable(isIndividual: true, isGlobal: false)
                    ->sortable()
                    ->hidden(true) // ->hidden(auth()->user()->email === 'admin@admin.com')
                    ->visible(true), // ->hidden(auth()->user()->email === 'admin@admin.com')
